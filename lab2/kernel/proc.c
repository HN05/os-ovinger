...
// Amount of priorities available in mlfq
#define PRIORNUM 4
static int quantum[PRIORNUM] = {
    2, 4, 8, -1 // -1 corresponds to FCFS
};
// Amount of time in ticks before reset
#define RESETTIME 200
struct spinlock boostlock;
uint boostleft = RESETTIME;
