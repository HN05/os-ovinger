...
free(void *ap)
{
 ...
 68c:	d587b783          	ld	a5,-680(a5) # 13e0 <freep>
 ...
 6b4:	00e6ea63          	bltu	a3,a4,6c8 <free+0x4a>
{
 ...
 6f6:	cef73723          	sd	a5,-786(a4) # 13e0 <freep>
}
 6fa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 720:	cc453503          	ld	a0,-828(a0) # 13e0 <freep>
 ...
 750:	c9490913          	addi	s2,s2,-876 # 13e0 <freep>
  if(p == (char*)-1)
 754:	5afd                	li	s5,-1
 ...
 764:	c9078793          	addi	a5,a5,-880 # 13f0 <base>
 ...
 7e2:	c0a73123          	sd	a0,-1022(a4) # 13e0 <freep>
      return (void*)(p + 1);
