...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	11250513          	addi	a0,a0,274 # 6150 <malloc+0x104>
      ...
      74:	8082                	ret
{
      ...
      84:	0f050513          	addi	a0,a0,240 # 6170 <malloc+0x124>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0e050513          	addi	a0,a0,224 # 6188 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0e250513          	addi	a0,a0,226 # 61a8 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0aa50513          	addi	a0,a0,170 # 6190 <malloc+0x144>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0b650513          	addi	a0,a0,182 # 61b8 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0b450513          	addi	a0,a0,180 # 61e0 <malloc+0x194>
     134:	00006097          	auipc	ra,0x6
     138:	b18080e7          	jalr	-1256(ra) # 5c4c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0a050513          	addi	a0,a0,160 # 61e0 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	09c58593          	addi	a1,a1,156 # 61f0 <malloc+0x1a4>
     15c:	00006097          	auipc	ra,0x6
     160:	ac0080e7          	jalr	-1344(ra) # 5c1c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	07850513          	addi	a0,a0,120 # 61e0 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	07c58593          	addi	a1,a1,124 # 61f8 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	04c50513          	addi	a0,a0,76 # 61e0 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	03650513          	addi	a0,a0,54 # 6200 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	fac50513          	addi	a0,a0,-84 # 6228 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f98a8a93          	addi	s5,s5,-104 # 6228 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f2650513          	addi	a0,a0,-218 # 6238 <malloc+0x1ec>
     ...
     338:	f2450513          	addi	a0,a0,-220 # 6258 <malloc+0x20c>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f1250513          	addi	a0,a0,-238 # 6270 <malloc+0x224>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	efe98993          	addi	s3,s3,-258 # 6270 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	eb250513          	addi	a0,a0,-334 # 6270 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e2258593          	addi	a1,a1,-478 # 61f8 <malloc+0x1ac>
    ...
    printf("write failed\n");
     ...
     3f0:	ea450513          	addi	a0,a0,-348 # 6290 <malloc+0x244>
    ...
    exit(1);
     ...
     40a:	e7250513          	addi	a0,a0,-398 # 6278 <malloc+0x22c>
    ...
    printf("open junk failed\n");
     ...
     424:	e5850513          	addi	a0,a0,-424 # 6278 <malloc+0x22c>
  ...
  unlink("junk");
     ...
     448:	e2c50513          	addi	a0,a0,-468 # 6270 <malloc+0x224>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d50a0a13          	addi	s4,s4,-688 # 62a0 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	cac50513          	addi	a0,a0,-852 # 62a8 <malloc+0x25c>
     ...
     61e:	ca650513          	addi	a0,a0,-858 # 62c0 <malloc+0x274>
     ...
     63c:	cb850513          	addi	a0,a0,-840 # 62f0 <malloc+0x2a4>
     ...
     656:	cce50513          	addi	a0,a0,-818 # 6320 <malloc+0x2d4>
     ...
     674:	cc050513          	addi	a0,a0,-832 # 6330 <malloc+0x2e4>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	cb2a0a13          	addi	s4,s4,-846 # 6360 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b42a8a93          	addi	s5,s5,-1214 # 61f8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	c0c50513          	addi	a0,a0,-1012 # 6368 <malloc+0x31c>
     764:	00006097          	auipc	ra,0x6
     768:	830080e7          	jalr	-2000(ra) # 5f94 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	c0650513          	addi	a0,a0,-1018 # 6380 <malloc+0x334>
     782:	00006097          	auipc	ra,0x6
     786:	812080e7          	jalr	-2030(ra) # 5f94 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b8c50513          	addi	a0,a0,-1140 # 6320 <malloc+0x2d4>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7f8080e7          	jalr	2040(ra) # 5f94 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	c0250513          	addi	a0,a0,-1022 # 63b0 <malloc+0x364>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	7de080e7          	jalr	2014(ra) # 5f94 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	bfc50513          	addi	a0,a0,-1028 # 63c8 <malloc+0x37c>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	7c0080e7          	jalr	1984(ra) # 5f94 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	9ce58593          	addi	a1,a1,-1586 # 61f0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	9a250513          	addi	a0,a0,-1630 # 61e0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	97650513          	addi	a0,a0,-1674 # 61e0 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	96250513          	addi	a0,a0,-1694 # 61e0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b9c58593          	addi	a1,a1,-1124 # 6458 <malloc+0x40c>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8e250513          	addi	a0,a0,-1822 # 61e0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	ab650513          	addi	a0,a0,-1354 # 63f8 <malloc+0x3ac>
     94a:	00005097          	auipc	ra,0x5
     94e:	64a080e7          	jalr	1610(ra) # 5f94 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	aba50513          	addi	a0,a0,-1350 # 6418 <malloc+0x3cc>
     966:	00005097          	auipc	ra,0x5
     96a:	62e080e7          	jalr	1582(ra) # 5f94 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	ab650513          	addi	a0,a0,-1354 # 6428 <malloc+0x3dc>
     97a:	00005097          	auipc	ra,0x5
     97e:	61a080e7          	jalr	1562(ra) # 5f94 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	aba50513          	addi	a0,a0,-1350 # 6448 <malloc+0x3fc>
     996:	00005097          	auipc	ra,0x5
     99a:	5fe080e7          	jalr	1534(ra) # 5f94 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a8650513          	addi	a0,a0,-1402 # 6428 <malloc+0x3dc>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	5ea080e7          	jalr	1514(ra) # 5f94 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	aa050513          	addi	a0,a0,-1376 # 6460 <malloc+0x414>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	5cc080e7          	jalr	1484(ra) # 5f94 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	aa250513          	addi	a0,a0,-1374 # 6480 <malloc+0x434>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	5ae080e7          	jalr	1454(ra) # 5f94 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a8e50513          	addi	a0,a0,-1394 # 64a0 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a9e98993          	addi	s3,s3,-1378 # 64c8 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	acea8a93          	addi	s5,s5,-1330 # 6500 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a2850513          	addi	a0,a0,-1496 # 64a0 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9ec50513          	addi	a0,a0,-1556 # 64a0 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	9ca50513          	addi	a0,a0,-1590 # 64a8 <malloc+0x45c>
     ae6:	00005097          	auipc	ra,0x5
     aea:	4ae080e7          	jalr	1198(ra) # 5f94 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	9dc50513          	addi	a0,a0,-1572 # 64d8 <malloc+0x48c>
     b04:	00005097          	auipc	ra,0x5
     b08:	490080e7          	jalr	1168(ra) # 5f94 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	9f650513          	addi	a0,a0,-1546 # 6510 <malloc+0x4c4>
     b22:	00005097          	auipc	ra,0x5
     b26:	472080e7          	jalr	1138(ra) # 5f94 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a0250513          	addi	a0,a0,-1534 # 6538 <malloc+0x4ec>
     b3e:	00005097          	auipc	ra,0x5
     b42:	456080e7          	jalr	1110(ra) # 5f94 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a0650513          	addi	a0,a0,-1530 # 6558 <malloc+0x50c>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	43a080e7          	jalr	1082(ra) # 5f94 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a0250513          	addi	a0,a0,-1534 # 6570 <malloc+0x524>
     b76:	00005097          	auipc	ra,0x5
     b7a:	41e080e7          	jalr	1054(ra) # 5f94 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9f050513          	addi	a0,a0,-1552 # 6590 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	99e50513          	addi	a0,a0,-1634 # 6590 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	95e50513          	addi	a0,a0,-1698 # 6598 <malloc+0x54c>
     c42:	00005097          	auipc	ra,0x5
     c46:	352080e7          	jalr	850(ra) # 5f94 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	96050513          	addi	a0,a0,-1696 # 65b8 <malloc+0x56c>
     c60:	00005097          	auipc	ra,0x5
     c64:	334080e7          	jalr	820(ra) # 5f94 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	96c50513          	addi	a0,a0,-1684 # 65e0 <malloc+0x594>
     c7c:	00005097          	auipc	ra,0x5
     c80:	318080e7          	jalr	792(ra) # 5f94 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8f050513          	addi	a0,a0,-1808 # 6590 <malloc+0x544>
     ...
     cd0:	93450513          	addi	a0,a0,-1740 # 6600 <malloc+0x5b4>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	2c0080e7          	jalr	704(ra) # 5f94 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	93e50513          	addi	a0,a0,-1730 # 6628 <malloc+0x5dc>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	2a2080e7          	jalr	674(ra) # 5f94 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	93850513          	addi	a0,a0,-1736 # 6640 <malloc+0x5f4>
     d10:	00005097          	auipc	ra,0x5
     d14:	284080e7          	jalr	644(ra) # 5f94 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	94450513          	addi	a0,a0,-1724 # 6668 <malloc+0x61c>
     d2c:	00005097          	auipc	ra,0x5
     d30:	268080e7          	jalr	616(ra) # 5f94 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	92e50513          	addi	a0,a0,-1746 # 6680 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	94658593          	addi	a1,a1,-1722 # 66b0 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8fa50513          	addi	a0,a0,-1798 # 6680 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8e450513          	addi	a0,a0,-1820 # 6680 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8ce50513          	addi	a0,a0,-1842 # 6680 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	93258593          	addi	a1,a1,-1742 # 66f8 <malloc+0x6ac>
  ...
  unlink("unlinkread");
     ...
     e32:	85250513          	addi	a0,a0,-1966 # 6680 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	84250513          	addi	a0,a0,-1982 # 6690 <malloc+0x644>
     e56:	00005097          	auipc	ra,0x5
     e5a:	13e080e7          	jalr	318(ra) # 5f94 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	84e50513          	addi	a0,a0,-1970 # 66b8 <malloc+0x66c>
     e72:	00005097          	auipc	ra,0x5
     e76:	122080e7          	jalr	290(ra) # 5f94 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	85250513          	addi	a0,a0,-1966 # 66d8 <malloc+0x68c>
     e8e:	00005097          	auipc	ra,0x5
     e92:	106080e7          	jalr	262(ra) # 5f94 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	85e50513          	addi	a0,a0,-1954 # 6700 <malloc+0x6b4>
     eaa:	00005097          	auipc	ra,0x5
     eae:	0ea080e7          	jalr	234(ra) # 5f94 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	86250513          	addi	a0,a0,-1950 # 6720 <malloc+0x6d4>
     ec6:	00005097          	auipc	ra,0x5
     eca:	0ce080e7          	jalr	206(ra) # 5f94 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	86650513          	addi	a0,a0,-1946 # 6740 <malloc+0x6f4>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	0b2080e7          	jalr	178(ra) # 5f94 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	77258593          	addi	a1,a1,1906 # 66b0 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	80a58593          	addi	a1,a1,-2038 # 6768 <malloc+0x71c>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7fa50513          	addi	a0,a0,2042 # 6760 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f7e:	7e650513          	addi	a0,a0,2022 # 6760 <malloc+0x714>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7d450513          	addi	a0,a0,2004 # 6760 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	7c650513          	addi	a0,a0,1990 # 6768 <malloc+0x71c>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	78e58593          	addi	a1,a1,1934 # 6768 <malloc+0x71c>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	77850513          	addi	a0,a0,1912 # 6768 <malloc+0x71c>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	76058593          	addi	a1,a1,1888 # 6760 <malloc+0x714>
    1008:	00005517          	auipc	a0,0x5
    100c:	76050513          	addi	a0,a0,1888 # 6768 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	74458593          	addi	a1,a1,1860 # 6760 <malloc+0x714>
    1024:	00006517          	auipc	a0,0x6
    1028:	84c50513          	addi	a0,a0,-1972 # 6870 <malloc+0x824>
    ...
    104a:	72a50513          	addi	a0,a0,1834 # 6770 <malloc+0x724>
    104e:	00005097          	auipc	ra,0x5
    1052:	f46080e7          	jalr	-186(ra) # 5f94 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	72650513          	addi	a0,a0,1830 # 6788 <malloc+0x73c>
    106a:	00005097          	auipc	ra,0x5
    106e:	f2a080e7          	jalr	-214(ra) # 5f94 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	72250513          	addi	a0,a0,1826 # 67a0 <malloc+0x754>
    1086:	00005097          	auipc	ra,0x5
    108a:	f0e080e7          	jalr	-242(ra) # 5f94 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	72650513          	addi	a0,a0,1830 # 67c0 <malloc+0x774>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	ef2080e7          	jalr	-270(ra) # 5f94 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	73a50513          	addi	a0,a0,1850 # 67f0 <malloc+0x7a4>
    10be:	00005097          	auipc	ra,0x5
    10c2:	ed6080e7          	jalr	-298(ra) # 5f94 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	73650513          	addi	a0,a0,1846 # 6808 <malloc+0x7bc>
    10da:	00005097          	auipc	ra,0x5
    10de:	eba080e7          	jalr	-326(ra) # 5f94 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	73250513          	addi	a0,a0,1842 # 6820 <malloc+0x7d4>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e9e080e7          	jalr	-354(ra) # 5f94 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	73e50513          	addi	a0,a0,1854 # 6848 <malloc+0x7fc>
    1112:	00005097          	auipc	ra,0x5
    1116:	e82080e7          	jalr	-382(ra) # 5f94 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	75250513          	addi	a0,a0,1874 # 6878 <malloc+0x82c>
    112e:	00005097          	auipc	ra,0x5
    1132:	e66080e7          	jalr	-410(ra) # 5f94 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	74098993          	addi	s3,s3,1856 # 6898 <malloc+0x84c>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	71450513          	addi	a0,a0,1812 # 68a8 <malloc+0x85c>
    119c:	00005097          	auipc	ra,0x5
    11a0:	df8080e7          	jalr	-520(ra) # 5f94 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	6cea0a13          	addi	s4,s4,1742 # 68c8 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	67c50513          	addi	a0,a0,1660 # 68c8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	61450513          	addi	a0,a0,1556 # 68d0 <malloc+0x884>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	cd0080e7          	jalr	-816(ra) # 5f94 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	61450513          	addi	a0,a0,1556 # 68f0 <malloc+0x8a4>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	cb0080e7          	jalr	-848(ra) # 5f94 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	61850513          	addi	a0,a0,1560 # 6910 <malloc+0x8c4>
    1300:	00005097          	auipc	ra,0x5
    1304:	c94080e7          	jalr	-876(ra) # 5f94 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	e2498993          	addi	s3,s3,-476 # 6188 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	77a78793          	addi	a5,a5,1914 # 7b68 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    144e:	16678793          	addi	a5,a5,358 # 85b0 <malloc+0x2564>
    ...
    1472:	d1a50513          	addi	a0,a0,-742 # 6188 <malloc+0x13c>
    ...
    148a:	53250513          	addi	a0,a0,1330 # 69b8 <malloc+0x96c>
    148e:	00005097          	auipc	ra,0x5
    1492:	b06080e7          	jalr	-1274(ra) # 5f94 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	48a50513          	addi	a0,a0,1162 # 6930 <malloc+0x8e4>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	ae6080e7          	jalr	-1306(ra) # 5f94 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	48a50513          	addi	a0,a0,1162 # 6950 <malloc+0x904>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	ac6080e7          	jalr	-1338(ra) # 5f94 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	48850513          	addi	a0,a0,1160 # 6970 <malloc+0x924>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	aa4080e7          	jalr	-1372(ra) # 5f94 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	49050513          	addi	a0,a0,1168 # 6998 <malloc+0x94c>
    1510:	00005097          	auipc	ra,0x5
    1514:	a84080e7          	jalr	-1404(ra) # 5f94 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	8f650513          	addi	a0,a0,-1802 # 6e18 <malloc+0xdcc>
    152a:	00005097          	auipc	ra,0x5
    152e:	a6a080e7          	jalr	-1430(ra) # 5f94 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	47450513          	addi	a0,a0,1140 # 69e0 <malloc+0x994>
    1574:	00005097          	auipc	ra,0x5
    1578:	a20080e7          	jalr	-1504(ra) # 5f94 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159a:	c4a50513          	addi	a0,a0,-950 # 61e0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15cc:	c18a0a13          	addi	s4,s4,-1000 # 61e0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	470a8a93          	addi	s5,s5,1136 # 6a40 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    16ac:	b38a0a13          	addi	s4,s4,-1224 # 61e0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	3c0a8a93          	addi	s5,s5,960 # 6a70 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16fe:	ae650513          	addi	a0,a0,-1306 # 61e0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    171c:	31050513          	addi	a0,a0,784 # 6a28 <malloc+0x9dc>
    1720:	00005097          	auipc	ra,0x5
    1724:	874080e7          	jalr	-1932(ra) # 5f94 <printf>
      exit(1);
    1728:	4505                	li	a0,1
    ...
    173a:	34250513          	addi	a0,a0,834 # 6a78 <malloc+0xa2c>
    173e:	00005097          	auipc	ra,0x5
    1742:	856080e7          	jalr	-1962(ra) # 5f94 <printf>
      exit(1);
    1746:	4505                	li	a0,1
...
0000000000001750 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1760:	a2c78793          	addi	a5,a5,-1492 # 6188 <malloc+0x13c>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	33078793          	addi	a5,a5,816 # 6a98 <malloc+0xa4c>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	32850513          	addi	a0,a0,808 # 6aa0 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    17ac:	2f850513          	addi	a0,a0,760 # 6aa0 <malloc+0xa54>
    ...
    17c8:	2fc50513          	addi	a0,a0,764 # 6ac0 <malloc+0xa74>
    17cc:	00004097          	auipc	ra,0x4
    17d0:	7c8080e7          	jalr	1992(ra) # 5f94 <printf>
      exit(1);
    17d4:	4505                	li	a0,1
    ...
    17e6:	22e50513          	addi	a0,a0,558 # 6a10 <malloc+0x9c4>
    17ea:	00004097          	auipc	ra,0x4
    17ee:	7aa080e7          	jalr	1962(ra) # 5f94 <printf>
     exit(1);
    17f2:	4505                	li	a0,1
    ...
    1802:	2aa50513          	addi	a0,a0,682 # 6aa8 <malloc+0xa5c>
    1806:	00004097          	auipc	ra,0x4
    180a:	78e080e7          	jalr	1934(ra) # 5f94 <printf>
      exit(1);
    180e:	4505                	li	a0,1
    ...
    1820:	96c50513          	addi	a0,a0,-1684 # 6188 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1854:	28050513          	addi	a0,a0,640 # 6ad0 <malloc+0xa84>
    1858:	00004097          	auipc	ra,0x4
    185c:	73c080e7          	jalr	1852(ra) # 5f94 <printf>
      exit(1);
    1860:	4505                	li	a0,1
    ...
    1870:	27c50513          	addi	a0,a0,636 # 6ae8 <malloc+0xa9c>
    1874:	00004097          	auipc	ra,0x4
    1878:	720080e7          	jalr	1824(ra) # 5f94 <printf>
    187c:	b7d1                	j	1840 <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    187e:	4581                	li	a1,0
    1880:	00005517          	auipc	a0,0x5
    1884:	22050513          	addi	a0,a0,544 # 6aa0 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18ae:	cae50513          	addi	a0,a0,-850 # 6558 <malloc+0x50c>
    18b2:	00004097          	auipc	ra,0x4
    18b6:	6e2080e7          	jalr	1762(ra) # 5f94 <printf>
    exit(1);
    18ba:	4505                	li	a0,1
    ...
    18ca:	16250513          	addi	a0,a0,354 # 6a28 <malloc+0x9dc>
    18ce:	00004097          	auipc	ra,0x4
    18d2:	6c6080e7          	jalr	1734(ra) # 5f94 <printf>
    exit(1);
    18d6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18e4:	1c050513          	addi	a0,a0,448 # 6aa0 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	1f650513          	addi	a0,a0,502 # 6b00 <malloc+0xab4>
    1912:	00004097          	auipc	ra,0x4
    1916:	682080e7          	jalr	1666(ra) # 5f94 <printf>
    exit(1);
    191a:	4505                	li	a0,1
...
000000000000192e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19d6:	14650513          	addi	a0,a0,326 # 6b18 <malloc+0xacc>
    19da:	00004097          	auipc	ra,0x4
    19de:	5ba080e7          	jalr	1466(ra) # 5f94 <printf>
    exit(1);
    19e2:	4505                	li	a0,1
    ...
    1a18:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	0d050513          	addi	a0,a0,208 # 6b30 <malloc+0xae4>
    1a68:	00004097          	auipc	ra,0x4
    1a6c:	52c080e7          	jalr	1324(ra) # 5f94 <printf>
        exit(1);
    1a70:	4505                	li	a0,1
    ...
    1a80:	0cc50513          	addi	a0,a0,204 # 6b48 <malloc+0xafc>
    1a84:	00004097          	auipc	ra,0x4
    1a88:	510080e7          	jalr	1296(ra) # 5f94 <printf>
          return;
    ...
    1ab2:	0b250513          	addi	a0,a0,178 # 6b60 <malloc+0xb14>
    1ab6:	00004097          	auipc	ra,0x4
    1aba:	4de080e7          	jalr	1246(ra) # 5f94 <printf>
      exit(1);
    1abe:	4505                	li	a0,1
    ...
    1afe:	08650513          	addi	a0,a0,134 # 6b80 <malloc+0xb34>
    1b02:	00004097          	auipc	ra,0x4
    1b06:	492080e7          	jalr	1170(ra) # 5f94 <printf>
    exit(1);
    1b0a:	4505                	li	a0,1
...
0000000000001b14 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b70:	ea450513          	addi	a0,a0,-348 # 6a10 <malloc+0x9c4>
    1b74:	00004097          	auipc	ra,0x4
    1b78:	420080e7          	jalr	1056(ra) # 5f94 <printf>
      exit(1);
    1b7c:	4505                	li	a0,1
    ...
    1b8c:	01050513          	addi	a0,a0,16 # 6b98 <malloc+0xb4c>
    1b90:	00004097          	auipc	ra,0x4
    1b94:	404080e7          	jalr	1028(ra) # 5f94 <printf>
        exit(1);
    1b98:	4505                	li	a0,1
    ...
    1ba8:	00c50513          	addi	a0,a0,12 # 6bb0 <malloc+0xb64>
    1bac:	00004097          	auipc	ra,0x4
    1bb0:	3e8080e7          	jalr	1000(ra) # 5f94 <printf>
        exit(1);
    1bb4:	4505                	li	a0,1
...
0000000000001bc8 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c20:	df450513          	addi	a0,a0,-524 # 6a10 <malloc+0x9c4>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	370080e7          	jalr	880(ra) # 5f94 <printf>
      exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c44:	dd050513          	addi	a0,a0,-560 # 6a10 <malloc+0x9c4>
    1c48:	00004097          	auipc	ra,0x4
    1c4c:	34c080e7          	jalr	844(ra) # 5f94 <printf>
        exit(1);
    1c50:	4505                	li	a0,1
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	f1650513          	addi	a0,a0,-234 # 6bd0 <malloc+0xb84>
    1cc2:	00004097          	auipc	ra,0x4
    1cc6:	2d2080e7          	jalr	722(ra) # 5f94 <printf>
      exit(1);
    1cca:	4505                	li	a0,1
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	ece50513          	addi	a0,a0,-306 # 6be0 <malloc+0xb94>
    1d1a:	00004097          	auipc	ra,0x4
    1d1e:	27a080e7          	jalr	634(ra) # 5f94 <printf>
      exit(1);
    1d22:	4505                	li	a0,1
...
0000000000001d2c <reparent2>:
{
  ...
  exit(0);
    ...
    1d64:	0b850513          	addi	a0,a0,184 # 6e18 <malloc+0xdcc>
    1d68:	00004097          	auipc	ra,0x4
    1d6c:	22c080e7          	jalr	556(ra) # 5f94 <printf>
      exit(1);
    1d70:	4505                	li	a0,1
...
0000000000001d94 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e02:	01a50513          	addi	a0,a0,26 # 6e18 <malloc+0xdcc>
    1e06:	00004097          	auipc	ra,0x4
    1e0a:	18e080e7          	jalr	398(ra) # 5f94 <printf>
      exit(1);
    1e0e:	4505                	li	a0,1
    ...
    1e2e:	c7e50513          	addi	a0,a0,-898 # 6aa8 <malloc+0xa5c>
    1e32:	00004097          	auipc	ra,0x4
    1e36:	162080e7          	jalr	354(ra) # 5f94 <printf>
          exit(1);
    1e3a:	4505                	li	a0,1
    ...
    1ea0:	d6450513          	addi	a0,a0,-668 # 6c00 <malloc+0xbb4>
    1ea4:	00004097          	auipc	ra,0x4
    1ea8:	0f0080e7          	jalr	240(ra) # 5f94 <printf>
            exit(1);
    1eac:	4505                	li	a0,1
    ...
    1ed4:	d4850513          	addi	a0,a0,-696 # 6c18 <malloc+0xbcc>
    1ed8:	00004097          	auipc	ra,0x4
    1edc:	0bc080e7          	jalr	188(ra) # 5f94 <printf>
        exit(1);
    1ee0:	4505                	li	a0,1
    ...
    1f36:	d0e50513          	addi	a0,a0,-754 # 6c40 <malloc+0xbf4>
    1f3a:	00004097          	auipc	ra,0x4
    1f3e:	05a080e7          	jalr	90(ra) # 5f94 <printf>
        exit(1);
    1f42:	4505                	li	a0,1
...
0000000000001fba <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fda:	22250513          	addi	a0,a0,546 # 61f8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2016:	1e6b0b13          	addi	s6,s6,486 # 61f8 <malloc+0x1ac>
      link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	c4ec0c13          	addi	s8,s8,-946 # 6c68 <malloc+0xc1c>
    2022:	a825                	j	205a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	9ea50513          	addi	a0,a0,-1558 # 6a10 <malloc+0x9c4>
    202e:	00004097          	auipc	ra,0x4
    2032:	f66080e7          	jalr	-154(ra) # 5f94 <printf>
    exit(1);
    2036:	4505                	li	a0,1
...
00000000000020be <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ee:	bce50513          	addi	a0,a0,-1074 # 6cb8 <malloc+0xc6c>
    20f2:	00004097          	auipc	ra,0x4
    20f6:	ea2080e7          	jalr	-350(ra) # 5f94 <printf>
    exit(1);
    20fa:	4505                	li	a0,1
    ...
    2112:	b6250513          	addi	a0,a0,-1182 # 6c70 <malloc+0xc24>
    2116:	00004097          	auipc	ra,0x4
    211a:	e7e080e7          	jalr	-386(ra) # 5f94 <printf>
    exit(1);
    211e:	4505                	li	a0,1
    ...
    212e:	b5e50513          	addi	a0,a0,-1186 # 6c88 <malloc+0xc3c>
    2132:	00004097          	auipc	ra,0x4
    2136:	e62080e7          	jalr	-414(ra) # 5f94 <printf>
      exit(1);
    213a:	4505                	li	a0,1
    ...
    214a:	b5a50513          	addi	a0,a0,-1190 # 6ca0 <malloc+0xc54>
    214e:	00004097          	auipc	ra,0x4
    2152:	e46080e7          	jalr	-442(ra) # 5f94 <printf>
    exit(1);
    2156:	4505                	li	a0,1
...
0000000000002196 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2200:	81450513          	addi	a0,a0,-2028 # 6a10 <malloc+0x9c4>
    2204:	00004097          	auipc	ra,0x4
    2208:	d90080e7          	jalr	-624(ra) # 5f94 <printf>
      exit(1);
    220c:	4505                	li	a0,1
    ...
    2222:	ac250513          	addi	a0,a0,-1342 # 6ce0 <malloc+0xc94>
    2226:	00004097          	auipc	ra,0x4
    222a:	d6e080e7          	jalr	-658(ra) # 5f94 <printf>
      exit(1);
    222e:	4505                	li	a0,1
...
0000000000002242 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a4:	77050513          	addi	a0,a0,1904 # 6a10 <malloc+0x9c4>
    22a8:	00004097          	auipc	ra,0x4
    22ac:	cec080e7          	jalr	-788(ra) # 5f94 <printf>
      exit(1);
    22b0:	4505                	li	a0,1
    ...
    22d0:	a3450513          	addi	a0,a0,-1484 # 6d00 <malloc+0xcb4>
    22d4:	00004097          	auipc	ra,0x4
    22d8:	cc0080e7          	jalr	-832(ra) # 5f94 <printf>
      exit(1);
    22dc:	4505                	li	a0,1
...
00000000000022f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2300:	a1c50513          	addi	a0,a0,-1508 # 6d18 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2332:	9ea50513          	addi	a0,a0,-1558 # 6d18 <malloc+0xccc>
  ...
  close(fd);
    ...
    2368:	9c470713          	addi	a4,a4,-1596 # 6d28 <malloc+0xcdc>
    ...
    23bc:	a5050513          	addi	a0,a0,-1456 # 6e08 <malloc+0xdbc>
    23c0:	00004097          	auipc	ra,0x4
    23c4:	bd4080e7          	jalr	-1068(ra) # 5f94 <printf>
    exit(1);
    23c8:	4505                	li	a0,1
    ...
    23e0:	a4c50513          	addi	a0,a0,-1460 # 6e28 <malloc+0xddc>
    23e4:	00004097          	auipc	ra,0x4
    23e8:	bb0080e7          	jalr	-1104(ra) # 5f94 <printf>
    exit(1);
    23ec:	4505                	li	a0,1
...
r_sp()
{
    ...
    243e:	a0e50513          	addi	a0,a0,-1522 # 6e48 <malloc+0xdfc>
    2442:	00004097          	auipc	ra,0x4
    2446:	b52080e7          	jalr	-1198(ra) # 5f94 <printf>
    exit(1);
    244a:	4505                	li	a0,1
    ...
    245a:	5ba50513          	addi	a0,a0,1466 # 6a10 <malloc+0x9c4>
    245e:	00004097          	auipc	ra,0x4
    2462:	b36080e7          	jalr	-1226(ra) # 5f94 <printf>
    exit(1);
    2466:	4505                	li	a0,1
...
000000000000247a <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24c8:	54c50513          	addi	a0,a0,1356 # 6a10 <malloc+0x9c4>
    24cc:	00004097          	auipc	ra,0x4
    24d0:	ac8080e7          	jalr	-1336(ra) # 5f94 <printf>
    exit(1);
    24d4:	4505                	li	a0,1
...
00000000000024e8 <manywrites>:
{
  ...
  exit(0);
    ...
    254c:	8d050513          	addi	a0,a0,-1840 # 6e18 <malloc+0xdcc>
    2550:	00004097          	auipc	ra,0x4
    2554:	a44080e7          	jalr	-1468(ra) # 5f94 <printf>
      exit(1);
    2558:	4505                	li	a0,1
    ...
    2602:	87250513          	addi	a0,a0,-1934 # 6e70 <malloc+0xe24>
    2606:	00004097          	auipc	ra,0x4
    260a:	98e080e7          	jalr	-1650(ra) # 5f94 <printf>
            exit(1);
    260e:	4505                	li	a0,1
    ...
    2622:	c3a50513          	addi	a0,a0,-966 # 6258 <malloc+0x20c>
    2626:	00004097          	auipc	ra,0x4
    262a:	96e080e7          	jalr	-1682(ra) # 5f94 <printf>
            exit(1);
    262e:	4505                	li	a0,1
...
0000000000002640 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26ba:	4b278793          	addi	a5,a5,1202 # 7b68 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26fc:	79050513          	addi	a0,a0,1936 # 6e88 <malloc+0xe3c>
    2700:	00004097          	auipc	ra,0x4
    2704:	894080e7          	jalr	-1900(ra) # 5f94 <printf>
    exit(1);
    2708:	4505                	li	a0,1
    ...
    271a:	21a50513          	addi	a0,a0,538 # 6930 <malloc+0x8e4>
    271e:	00004097          	auipc	ra,0x4
    2722:	876080e7          	jalr	-1930(ra) # 5f94 <printf>
    exit(1);
    2726:	4505                	li	a0,1
    ...
    2738:	21c50513          	addi	a0,a0,540 # 6950 <malloc+0x904>
    273c:	00004097          	auipc	ra,0x4
    2740:	858080e7          	jalr	-1960(ra) # 5f94 <printf>
    exit(1);
    2744:	4505                	li	a0,1
    ...
    2758:	21c50513          	addi	a0,a0,540 # 6970 <malloc+0x924>
    275c:	00004097          	auipc	ra,0x4
    2760:	838080e7          	jalr	-1992(ra) # 5f94 <printf>
    exit(1);
    2764:	4505                	li	a0,1
    ...
    2776:	22650513          	addi	a0,a0,550 # 6998 <malloc+0x94c>
    277a:	00004097          	auipc	ra,0x4
    277e:	81a080e7          	jalr	-2022(ra) # 5f94 <printf>
    exit(1);
    2782:	4505                	li	a0,1
...
000000000000278c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c2:	70a50513          	addi	a0,a0,1802 # 6ec8 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27f2:	6fa50513          	addi	a0,a0,1786 # 6ee8 <malloc+0xe9c>
    27f6:	00003097          	auipc	ra,0x3
    27fa:	79e080e7          	jalr	1950(ra) # 5f94 <printf>
    exit(1);
    27fe:	4505                	li	a0,1
    ...
    2810:	68450513          	addi	a0,a0,1668 # 6e90 <malloc+0xe44>
    2814:	00003097          	auipc	ra,0x3
    2818:	780080e7          	jalr	1920(ra) # 5f94 <printf>
    exit(1);
    281c:	4505                	li	a0,1
    ...
    282c:	68050513          	addi	a0,a0,1664 # 6ea8 <malloc+0xe5c>
    2830:	00003097          	auipc	ra,0x3
    2834:	764080e7          	jalr	1892(ra) # 5f94 <printf>
    exit(1);
    2838:	4505                	li	a0,1
    ...
    2846:	68e50513          	addi	a0,a0,1678 # 6ed0 <malloc+0xe84>
    284a:	00003097          	auipc	ra,0x3
    284e:	74a080e7          	jalr	1866(ra) # 5f94 <printf>
    exit(1);
    2852:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    286a:	66250513          	addi	a0,a0,1634 # 6ec8 <malloc+0xe7c>
    286e:	00003097          	auipc	ra,0x3
    2872:	3de080e7          	jalr	990(ra) # 5c4c <unlink>
  fd = open("README", O_RDONLY);
    2876:	4581                	li	a1,0
    2878:	00004517          	auipc	a0,0x4
    287c:	ae850513          	addi	a0,a0,-1304 # 6360 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    28a6:	67650513          	addi	a0,a0,1654 # 6f18 <malloc+0xecc>
    28aa:	00003097          	auipc	ra,0x3
    28ae:	6ea080e7          	jalr	1770(ra) # 5f94 <printf>
    exit(1);
    28b2:	4505                	li	a0,1
    ...
    28c0:	61450513          	addi	a0,a0,1556 # 6ed0 <malloc+0xe84>
    28c4:	00003097          	auipc	ra,0x3
    28c8:	6d0080e7          	jalr	1744(ra) # 5f94 <printf>
    exit(1);
    28cc:	4505                	li	a0,1
...
00000000000028ea <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2946:	5fe50513          	addi	a0,a0,1534 # 6f40 <malloc+0xef4>
    294a:	00003097          	auipc	ra,0x3
    294e:	64a080e7          	jalr	1610(ra) # 5f94 <printf>
    exit(1);
    2952:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    29aa:	5ba50513          	addi	a0,a0,1466 # 6f60 <malloc+0xf14>
    29ae:	00003097          	auipc	ra,0x3
    29b2:	5e6080e7          	jalr	1510(ra) # 5f94 <printf>
    exit(1);
    29b6:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2a0e:	5b650513          	addi	a0,a0,1462 # 6fc0 <malloc+0xf74>
    2a12:	00003097          	auipc	ra,0x3
    2a16:	582080e7          	jalr	1410(ra) # 5f94 <printf>
    exit(1);
    2a1a:	4505                	li	a0,1
    ...
    2a30:	55450513          	addi	a0,a0,1364 # 6f80 <malloc+0xf34>
    2a34:	00003097          	auipc	ra,0x3
    2a38:	560080e7          	jalr	1376(ra) # 5f94 <printf>
      exit(1);
    2a3c:	4505                	li	a0,1
    ...
    2a4c:	55850513          	addi	a0,a0,1368 # 6fa0 <malloc+0xf54>
    2a50:	00003097          	auipc	ra,0x3
    2a54:	544080e7          	jalr	1348(ra) # 5f94 <printf>
    exit(1);
    2a58:	4505                	li	a0,1
...
0000000000002a88 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b96:	44e50513          	addi	a0,a0,1102 # 6fe0 <malloc+0xf94>
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	3fa080e7          	jalr	1018(ra) # 5f94 <printf>
    exit(1);
    2ba2:	4505                	li	a0,1
    ...
    2bb2:	47a50513          	addi	a0,a0,1146 # 7028 <malloc+0xfdc>
    2bb6:	00003097          	auipc	ra,0x3
    2bba:	3de080e7          	jalr	990(ra) # 5f94 <printf>
    exit(1);
    2bbe:	4505                	li	a0,1
    ...
    2bd2:	47a50513          	addi	a0,a0,1146 # 7048 <malloc+0xffc>
    2bd6:	00003097          	auipc	ra,0x3
    2bda:	3be080e7          	jalr	958(ra) # 5f94 <printf>
    exit(1);
    2bde:	4505                	li	a0,1
    ...
    2bf2:	49a50513          	addi	a0,a0,1178 # 7088 <malloc+0x103c>
    2bf6:	00003097          	auipc	ra,0x3
    2bfa:	39e080e7          	jalr	926(ra) # 5f94 <printf>
    exit(1);
    2bfe:	4505                	li	a0,1
    ...
    2c0e:	4ae50513          	addi	a0,a0,1198 # 70b8 <malloc+0x106c>
    2c12:	00003097          	auipc	ra,0x3
    2c16:	382080e7          	jalr	898(ra) # 5f94 <printf>
    exit(1);
    2c1a:	4505                	li	a0,1
    ...
    2c2e:	4c650513          	addi	a0,a0,1222 # 70f0 <malloc+0x10a4>
    2c32:	00003097          	auipc	ra,0x3
    2c36:	362080e7          	jalr	866(ra) # 5f94 <printf>
    exit(1);
    2c3a:	4505                	li	a0,1
...
0000000000002c44 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c68:	4b450513          	addi	a0,a0,1204 # 7118 <malloc+0x10cc>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	4a250513          	addi	a0,a0,1186 # 7118 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cce:	45650513          	addi	a0,a0,1110 # 7120 <malloc+0x10d4>
    2cd2:	00003097          	auipc	ra,0x3
    2cd6:	2c2080e7          	jalr	706(ra) # 5f94 <printf>
    exit(1);
    2cda:	4505                	li	a0,1
    ...
    2cea:	45250513          	addi	a0,a0,1106 # 7138 <malloc+0x10ec>
    2cee:	00003097          	auipc	ra,0x3
    2cf2:	2a6080e7          	jalr	678(ra) # 5f94 <printf>
    exit(1);
    2cf6:	4505                	li	a0,1
    ...
    2d06:	e1650513          	addi	a0,a0,-490 # 6b18 <malloc+0xacc>
    2d0a:	00003097          	auipc	ra,0x3
    2d0e:	28a080e7          	jalr	650(ra) # 5f94 <printf>
    exit(1);
    2d12:	4505                	li	a0,1
...
0000000000002d1c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d30:	42450513          	addi	a0,a0,1060 # 7150 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d78:	cb450513          	addi	a0,a0,-844 # 6a28 <malloc+0x9dc>
    2d7c:	00003097          	auipc	ra,0x3
    2d80:	218080e7          	jalr	536(ra) # 5f94 <printf>
    exit(1);
    2d84:	4505                	li	a0,1
...
0000000000002d8e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc6:	05650513          	addi	a0,a0,86 # 6e18 <malloc+0xdcc>
    2dca:	00003097          	auipc	ra,0x3
    2dce:	1ca080e7          	jalr	458(ra) # 5f94 <printf>
    exit(1);
    2dd2:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e24:	174080e7          	jalr	372(ra) # 5f94 <printf>
    exit(1);
    2e28:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e7c:	fa050513          	addi	a0,a0,-96 # 6e18 <malloc+0xdcc>
    2e80:	00003097          	auipc	ra,0x3
    2e84:	114080e7          	jalr	276(ra) # 5f94 <printf>
    exit(1);
    2e88:	4505                	li	a0,1
...
0000000000002fae <execout>:
{
  ...
  exit(0);
    ...
    2ff0:	e2c50513          	addi	a0,a0,-468 # 6e18 <malloc+0xdcc>
    2ff4:	00003097          	auipc	ra,0x3
    2ff8:	fa0080e7          	jalr	-96(ra) # 5f94 <printf>
      exit(1);
    2ffc:	4505                	li	a0,1
    ...
    3044:	14850513          	addi	a0,a0,328 # 6188 <malloc+0x13c>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	1ac78793          	addi	a5,a5,428 # 61f8 <malloc+0x1ac>
...
0000000000003072 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3082:	2aa50513          	addi	a0,a0,682 # 7328 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3094:	0f050513          	addi	a0,a0,240 # 7180 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30aa:	13250513          	addi	a0,a0,306 # 71d8 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30c8:	18c50513          	addi	a0,a0,396 # 7250 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e4:	1e050513          	addi	a0,a0,480 # 72c0 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f6:	22650513          	addi	a0,a0,550 # 7318 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3174:	fe850513          	addi	a0,a0,-24 # 7158 <malloc+0x110c>
    3178:	00003097          	auipc	ra,0x3
    317c:	e1c080e7          	jalr	-484(ra) # 5f94 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	01450513          	addi	a0,a0,20 # 71a0 <malloc+0x1154>
    3194:	00003097          	auipc	ra,0x3
    3198:	e00080e7          	jalr	-512(ra) # 5f94 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	06050513          	addi	a0,a0,96 # 7208 <malloc+0x11bc>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	de4080e7          	jalr	-540(ra) # 5f94 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
    ...
    31c8:	0bc50513          	addi	a0,a0,188 # 7280 <malloc+0x1234>
    31cc:	00003097          	auipc	ra,0x3
    31d0:	dc8080e7          	jalr	-568(ra) # 5f94 <printf>
    exit(1);
    31d4:	4505                	li	a0,1
    ...
    31e4:	10050513          	addi	a0,a0,256 # 72e0 <malloc+0x1294>
    31e8:	00003097          	auipc	ra,0x3
    31ec:	dac080e7          	jalr	-596(ra) # 5f94 <printf>
    exit(1);
    31f0:	4505                	li	a0,1
    ...
    3200:	13c50513          	addi	a0,a0,316 # 7338 <malloc+0x12ec>
    3204:	00003097          	auipc	ra,0x3
    3208:	d90080e7          	jalr	-624(ra) # 5f94 <printf>
    exit(1);
    320c:	4505                	li	a0,1
...
0000000000003216 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    324c:	12850513          	addi	a0,a0,296 # 7370 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3276:	10e50513          	addi	a0,a0,270 # 7380 <malloc+0x1334>
    327a:	00003097          	auipc	ra,0x3
    327e:	d1a080e7          	jalr	-742(ra) # 5f94 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3306:	06e50513          	addi	a0,a0,110 # 7370 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    331a:	05a50513          	addi	a0,a0,90 # 7370 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3448:	f5c50513          	addi	a0,a0,-164 # 73a0 <malloc+0x1354>
    344c:	00003097          	auipc	ra,0x3
    3450:	b48080e7          	jalr	-1208(ra) # 5f94 <printf>
...
0000000000003456 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3466:	f6e50513          	addi	a0,a0,-146 # 73d0 <malloc+0x1384>
  ...
  if(chdir("iputdir") < 0){
    ...
    347a:	f5a50513          	addi	a0,a0,-166 # 73d0 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    348e:	f8650513          	addi	a0,a0,-122 # 7410 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    34a2:	fa250513          	addi	a0,a0,-94 # 7440 <malloc+0x13f4>
    ...
    34c2:	f1a50513          	addi	a0,a0,-230 # 73d8 <malloc+0x138c>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	ace080e7          	jalr	-1330(ra) # 5f94 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
    ...
    34de:	f1650513          	addi	a0,a0,-234 # 73f0 <malloc+0x13a4>
    34e2:	00003097          	auipc	ra,0x3
    34e6:	ab2080e7          	jalr	-1358(ra) # 5f94 <printf>
    exit(1);
    34ea:	4505                	li	a0,1
    ...
    34fa:	f2a50513          	addi	a0,a0,-214 # 7420 <malloc+0x13d4>
    34fe:	00003097          	auipc	ra,0x3
    3502:	a96080e7          	jalr	-1386(ra) # 5f94 <printf>
    exit(1);
    3506:	4505                	li	a0,1
    ...
    3516:	f3650513          	addi	a0,a0,-202 # 7448 <malloc+0x13fc>
    351a:	00003097          	auipc	ra,0x3
    351e:	a7a080e7          	jalr	-1414(ra) # 5f94 <printf>
    exit(1);
    3522:	4505                	li	a0,1
...
000000000000352c <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    354a:	e8a50513          	addi	a0,a0,-374 # 73d0 <malloc+0x1384>
    ...
    355e:	e7650513          	addi	a0,a0,-394 # 73d0 <malloc+0x1384>
    ...
    3572:	ea250513          	addi	a0,a0,-350 # 7410 <malloc+0x13c4>
    ...
    3592:	48250513          	addi	a0,a0,1154 # 6a10 <malloc+0x9c4>
    3596:	00003097          	auipc	ra,0x3
    359a:	9fe080e7          	jalr	-1538(ra) # 5f94 <printf>
    exit(1);
    359e:	4505                	li	a0,1
    ...
    35ae:	e2e50513          	addi	a0,a0,-466 # 73d8 <malloc+0x138c>
    35b2:	00003097          	auipc	ra,0x3
    35b6:	9e2080e7          	jalr	-1566(ra) # 5f94 <printf>
      exit(1);
    35ba:	4505                	li	a0,1
    ...
    35ca:	e9a50513          	addi	a0,a0,-358 # 7460 <malloc+0x1414>
    35ce:	00003097          	auipc	ra,0x3
    35d2:	9c6080e7          	jalr	-1594(ra) # 5f94 <printf>
      exit(1);
    35d6:	4505                	li	a0,1
    ...
    35e6:	e3e50513          	addi	a0,a0,-450 # 7420 <malloc+0x13d4>
    35ea:	00003097          	auipc	ra,0x3
    35ee:	9aa080e7          	jalr	-1622(ra) # 5f94 <printf>
      exit(1);
    35f2:	4505                	li	a0,1
...
0000000000003614 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3624:	e5850513          	addi	a0,a0,-424 # 7478 <malloc+0x142c>
  ...
  if(chdir("dir0") < 0){
    ...
    3638:	e4450513          	addi	a0,a0,-444 # 7478 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    364c:	e5050513          	addi	a0,a0,-432 # 7498 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3660:	e1c50513          	addi	a0,a0,-484 # 7478 <malloc+0x142c>
    ...
    3680:	d5c50513          	addi	a0,a0,-676 # 73d8 <malloc+0x138c>
    3684:	00003097          	auipc	ra,0x3
    3688:	910080e7          	jalr	-1776(ra) # 5f94 <printf>
    exit(1);
    368c:	4505                	li	a0,1
    ...
    369c:	de850513          	addi	a0,a0,-536 # 7480 <malloc+0x1434>
    36a0:	00003097          	auipc	ra,0x3
    36a4:	8f4080e7          	jalr	-1804(ra) # 5f94 <printf>
    exit(1);
    36a8:	4505                	li	a0,1
    ...
    36b8:	dec50513          	addi	a0,a0,-532 # 74a0 <malloc+0x1454>
    36bc:	00003097          	auipc	ra,0x3
    36c0:	8d8080e7          	jalr	-1832(ra) # 5f94 <printf>
    exit(1);
    36c4:	4505                	li	a0,1
    ...
    36d4:	de850513          	addi	a0,a0,-536 # 74b8 <malloc+0x146c>
    36d8:	00003097          	auipc	ra,0x3
    36dc:	8bc080e7          	jalr	-1860(ra) # 5f94 <printf>
    exit(1);
    36e0:	4505                	li	a0,1
...
00000000000036ea <subdir>:
{
  ...
  unlink("ff");
    ...
    36fc:	f0850513          	addi	a0,a0,-248 # 7600 <malloc+0x15b4>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
  if(mkdir("dd") != 0){
    3708:	00004517          	auipc	a0,0x4
    370c:	dc850513          	addi	a0,a0,-568 # 74d0 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3724:	dd050513          	addi	a0,a0,-560 # 74f0 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    373c:	ec858593          	addi	a1,a1,-312 # 7600 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    3756:	d7e50513          	addi	a0,a0,-642 # 74d0 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    376a:	de250513          	addi	a0,a0,-542 # 7548 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3782:	df250513          	addi	a0,a0,-526 # 7570 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    379a:	e0a58593          	addi	a1,a1,-502 # 75a0 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37b6:	df650513          	addi	a0,a0,-522 # 75a8 <malloc+0x155c>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37fe:	dfe58593          	addi	a1,a1,-514 # 75f8 <malloc+0x15ac>
    3802:	00004517          	auipc	a0,0x4
    3806:	d6e50513          	addi	a0,a0,-658 # 7570 <malloc+0x1524>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    381a:	d5a50513          	addi	a0,a0,-678 # 7570 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3830:	d4450513          	addi	a0,a0,-700 # 7570 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    3844:	c9050513          	addi	a0,a0,-880 # 74d0 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3858:	e3c50513          	addi	a0,a0,-452 # 7690 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    386c:	e5850513          	addi	a0,a0,-424 # 76c0 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3880:	e7450513          	addi	a0,a0,-396 # 76f0 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3896:	d6650513          	addi	a0,a0,-666 # 75f8 <malloc+0x15ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38d0:	ca450513          	addi	a0,a0,-860 # 7570 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38e8:	e9c50513          	addi	a0,a0,-356 # 7780 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3900:	eb450513          	addi	a0,a0,-332 # 77b0 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3918:	bbc50513          	addi	a0,a0,-1092 # 74d0 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    392e:	ba650513          	addi	a0,a0,-1114 # 74d0 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3944:	b9050513          	addi	a0,a0,-1136 # 74d0 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3958:	eec58593          	addi	a1,a1,-276 # 7840 <malloc+0x17f4>
    395c:	00004517          	auipc	a0,0x4
    3960:	e2450513          	addi	a0,a0,-476 # 7780 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3974:	ed058593          	addi	a1,a1,-304 # 7840 <malloc+0x17f4>
    3978:	00004517          	auipc	a0,0x4
    397c:	e3850513          	addi	a0,a0,-456 # 77b0 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3990:	c6c58593          	addi	a1,a1,-916 # 75f8 <malloc+0x15ac>
    3994:	00004517          	auipc	a0,0x4
    3998:	b5c50513          	addi	a0,a0,-1188 # 74f0 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39ac:	dd850513          	addi	a0,a0,-552 # 7780 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39c0:	df450513          	addi	a0,a0,-524 # 77b0 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39d4:	c2850513          	addi	a0,a0,-984 # 75f8 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39e8:	dcc50513          	addi	a0,a0,-564 # 77b0 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39fc:	d8850513          	addi	a0,a0,-632 # 7780 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a10:	ae450513          	addi	a0,a0,-1308 # 74f0 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a24:	f7050513          	addi	a0,a0,-144 # 7990 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a38:	bc450513          	addi	a0,a0,-1084 # 75f8 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a4c:	aa850513          	addi	a0,a0,-1368 # 74f0 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a60:	a7450513          	addi	a0,a0,-1420 # 74d0 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a74:	f9050513          	addi	a0,a0,-112 # 7a00 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a88:	a4c50513          	addi	a0,a0,-1460 # 74d0 <malloc+0x1484>
    ...
    3aaa:	a3250513          	addi	a0,a0,-1486 # 74d8 <malloc+0x148c>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	4e6080e7          	jalr	1254(ra) # 5f94 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a3650513          	addi	a0,a0,-1482 # 74f8 <malloc+0x14ac>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	4ca080e7          	jalr	1226(ra) # 5f94 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a3a50513          	addi	a0,a0,-1478 # 7518 <malloc+0x14cc>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	4ae080e7          	jalr	1198(ra) # 5f94 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a5650513          	addi	a0,a0,-1450 # 7550 <malloc+0x1504>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	492080e7          	jalr	1170(ra) # 5f94 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a6a50513          	addi	a0,a0,-1430 # 7580 <malloc+0x1534>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	476080e7          	jalr	1142(ra) # 5f94 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a8650513          	addi	a0,a0,-1402 # 75b8 <malloc+0x156c>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	45a080e7          	jalr	1114(ra) # 5f94 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a8a50513          	addi	a0,a0,-1398 # 75d8 <malloc+0x158c>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	43e080e7          	jalr	1086(ra) # 5f94 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a9e50513          	addi	a0,a0,-1378 # 7608 <malloc+0x15bc>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	422080e7          	jalr	1058(ra) # 5f94 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	aaa50513          	addi	a0,a0,-1366 # 7630 <malloc+0x15e4>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	406080e7          	jalr	1030(ra) # 5f94 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	aae50513          	addi	a0,a0,-1362 # 7650 <malloc+0x1604>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	3ea080e7          	jalr	1002(ra) # 5f94 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	aba50513          	addi	a0,a0,-1350 # 7678 <malloc+0x162c>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	3ce080e7          	jalr	974(ra) # 5f94 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	ac650513          	addi	a0,a0,-1338 # 76a0 <malloc+0x1654>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	3b2080e7          	jalr	946(ra) # 5f94 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	ada50513          	addi	a0,a0,-1318 # 76d0 <malloc+0x1684>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	396080e7          	jalr	918(ra) # 5f94 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	ae650513          	addi	a0,a0,-1306 # 76f8 <malloc+0x16ac>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	37a080e7          	jalr	890(ra) # 5f94 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	ae250513          	addi	a0,a0,-1310 # 7710 <malloc+0x16c4>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	35e080e7          	jalr	862(ra) # 5f94 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	ae650513          	addi	a0,a0,-1306 # 7730 <malloc+0x16e4>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	342080e7          	jalr	834(ra) # 5f94 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	aea50513          	addi	a0,a0,-1302 # 7750 <malloc+0x1704>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	326080e7          	jalr	806(ra) # 5f94 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	b0e50513          	addi	a0,a0,-1266 # 7790 <malloc+0x1744>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	30a080e7          	jalr	778(ra) # 5f94 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	b2250513          	addi	a0,a0,-1246 # 77c0 <malloc+0x1774>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	2ee080e7          	jalr	750(ra) # 5f94 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b2650513          	addi	a0,a0,-1242 # 77e0 <malloc+0x1794>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	2d2080e7          	jalr	722(ra) # 5f94 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b2a50513          	addi	a0,a0,-1238 # 7800 <malloc+0x17b4>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	2b6080e7          	jalr	694(ra) # 5f94 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b2e50513          	addi	a0,a0,-1234 # 7820 <malloc+0x17d4>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	29a080e7          	jalr	666(ra) # 5f94 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b4250513          	addi	a0,a0,-1214 # 7850 <malloc+0x1804>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	27e080e7          	jalr	638(ra) # 5f94 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b4e50513          	addi	a0,a0,-1202 # 7878 <malloc+0x182c>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	262080e7          	jalr	610(ra) # 5f94 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b5a50513          	addi	a0,a0,-1190 # 78a0 <malloc+0x1854>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	246080e7          	jalr	582(ra) # 5f94 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b6650513          	addi	a0,a0,-1178 # 78c8 <malloc+0x187c>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	22a080e7          	jalr	554(ra) # 5f94 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b6a50513          	addi	a0,a0,-1174 # 78e8 <malloc+0x189c>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	20e080e7          	jalr	526(ra) # 5f94 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b6e50513          	addi	a0,a0,-1170 # 7908 <malloc+0x18bc>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	1f2080e7          	jalr	498(ra) # 5f94 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b7a50513          	addi	a0,a0,-1158 # 7930 <malloc+0x18e4>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	1d6080e7          	jalr	470(ra) # 5f94 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	b7e50513          	addi	a0,a0,-1154 # 7950 <malloc+0x1904>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	1ba080e7          	jalr	442(ra) # 5f94 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b8250513          	addi	a0,a0,-1150 # 7970 <malloc+0x1924>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	19e080e7          	jalr	414(ra) # 5f94 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b8e50513          	addi	a0,a0,-1138 # 7998 <malloc+0x194c>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	182080e7          	jalr	386(ra) # 5f94 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	80a50513          	addi	a0,a0,-2038 # 7630 <malloc+0x15e4>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	166080e7          	jalr	358(ra) # 5f94 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b7650513          	addi	a0,a0,-1162 # 79b8 <malloc+0x196c>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	14a080e7          	jalr	330(ra) # 5f94 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
    ...
    3e62:	b7a50513          	addi	a0,a0,-1158 # 79d8 <malloc+0x198c>
    3e66:	00002097          	auipc	ra,0x2
    3e6a:	12e080e7          	jalr	302(ra) # 5f94 <printf>
    exit(1);
    3e6e:	4505                	li	a0,1
    ...
    3e7e:	b8e50513          	addi	a0,a0,-1138 # 7a08 <malloc+0x19bc>
    3e82:	00002097          	auipc	ra,0x2
    3e86:	112080e7          	jalr	274(ra) # 5f94 <printf>
    exit(1);
    3e8a:	4505                	li	a0,1
    ...
    3e9a:	b9250513          	addi	a0,a0,-1134 # 7a28 <malloc+0x19dc>
    3e9e:	00002097          	auipc	ra,0x2
    3ea2:	0f6080e7          	jalr	246(ra) # 5f94 <printf>
    exit(1);
    3ea6:	4505                	li	a0,1
...
0000000000003eb0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ec0:	b8450513          	addi	a0,a0,-1148 # 7a40 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3ed2:	b7250513          	addi	a0,a0,-1166 # 7a40 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3ee4:	99050513          	addi	a0,a0,-1648 # 6870 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3ef6:	5a650513          	addi	a0,a0,1446 # 7498 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3f08:	53c50513          	addi	a0,a0,1340 # 7440 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f1a:	b9250513          	addi	a0,a0,-1134 # 7aa8 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f2c:	ba850513          	addi	a0,a0,-1112 # 7ad0 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3f3e:	b0650513          	addi	a0,a0,-1274 # 7a40 <malloc+0x19f4>
    ...
    3f5c:	af050513          	addi	a0,a0,-1296 # 7a48 <malloc+0x19fc>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	034080e7          	jalr	52(ra) # 5f94 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	aec50513          	addi	a0,a0,-1300 # 7a60 <malloc+0x1a14>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	018080e7          	jalr	24(ra) # 5f94 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	ae850513          	addi	a0,a0,-1304 # 7a78 <malloc+0x1a2c>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	ffc080e7          	jalr	-4(ra) # 5f94 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	ae450513          	addi	a0,a0,-1308 # 7a90 <malloc+0x1a44>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	fe0080e7          	jalr	-32(ra) # 5f94 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	48050513          	addi	a0,a0,1152 # 7448 <malloc+0x13fc>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	fc4080e7          	jalr	-60(ra) # 5f94 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
    ...
    3fe8:	acc50513          	addi	a0,a0,-1332 # 7ab0 <malloc+0x1a64>
    3fec:	00002097          	auipc	ra,0x2
    3ff0:	fa8080e7          	jalr	-88(ra) # 5f94 <printf>
    exit(1);
    3ff4:	4505                	li	a0,1
    ...
    4004:	ad850513          	addi	a0,a0,-1320 # 7ad8 <malloc+0x1a8c>
    4008:	00002097          	auipc	ra,0x2
    400c:	f8c080e7          	jalr	-116(ra) # 5f94 <printf>
    exit(1);
    4010:	4505                	li	a0,1
    ...
    4020:	adc50513          	addi	a0,a0,-1316 # 7af8 <malloc+0x1aac>
    4024:	00002097          	auipc	ra,0x2
    4028:	f70080e7          	jalr	-144(ra) # 5f94 <printf>
    exit(1);
    402c:	4505                	li	a0,1
...
0000000000004036 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    404c:	ad050513          	addi	a0,a0,-1328 # 7b18 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    4068:	ab450513          	addi	a0,a0,-1356 # 7b18 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    407c:	ae850513          	addi	a0,a0,-1304 # 7b60 <malloc+0x1b14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4094:	ad050513          	addi	a0,a0,-1328 # 7b60 <malloc+0x1b14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40a8:	abc50513          	addi	a0,a0,-1348 # 7b60 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40bc:	aa850513          	addi	a0,a0,-1368 # 7b60 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40d0:	a9458593          	addi	a1,a1,-1388 # 7b60 <malloc+0x1b14>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	28c50513          	addi	a0,a0,652 # 6360 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ec:	a3050513          	addi	a0,a0,-1488 # 7b18 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    4102:	77250513          	addi	a0,a0,1906 # 6870 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    4118:	75c50513          	addi	a0,a0,1884 # 6870 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    412c:	0d058593          	addi	a1,a1,208 # 61f8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    4158:	9cc50513          	addi	a0,a0,-1588 # 7b20 <malloc+0x1ad4>
    415c:	00002097          	auipc	ra,0x2
    4160:	e38080e7          	jalr	-456(ra) # 5f94 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9d050513          	addi	a0,a0,-1584 # 7b40 <malloc+0x1af4>
    4178:	00002097          	auipc	ra,0x2
    417c:	e1c080e7          	jalr	-484(ra) # 5f94 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9e450513          	addi	a0,a0,-1564 # 7b70 <malloc+0x1b24>
    4194:	00002097          	auipc	ra,0x2
    4198:	e00080e7          	jalr	-512(ra) # 5f94 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9c850513          	addi	a0,a0,-1592 # 7b70 <malloc+0x1b24>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	de4080e7          	jalr	-540(ra) # 5f94 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9d450513          	addi	a0,a0,-1580 # 7b98 <malloc+0x1b4c>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	dc8080e7          	jalr	-568(ra) # 5f94 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9e050513          	addi	a0,a0,-1568 # 7bc0 <malloc+0x1b74>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	dac080e7          	jalr	-596(ra) # 5f94 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9ec50513          	addi	a0,a0,-1556 # 7be8 <malloc+0x1b9c>
    4204:	00002097          	auipc	ra,0x2
    4208:	d90080e7          	jalr	-624(ra) # 5f94 <printf>
    exit(1);
    420c:	4505                	li	a0,1
    ...
    421c:	9f850513          	addi	a0,a0,-1544 # 7c10 <malloc+0x1bc4>
    4220:	00002097          	auipc	ra,0x2
    4224:	d74080e7          	jalr	-652(ra) # 5f94 <printf>
    exit(1);
    4228:	4505                	li	a0,1
    ...
    4238:	9fc50513          	addi	a0,a0,-1540 # 7c30 <malloc+0x1be4>
    423c:	00002097          	auipc	ra,0x2
    4240:	d58080e7          	jalr	-680(ra) # 5f94 <printf>
    exit(1);
    4244:	4505                	li	a0,1
    ...
    4254:	a0850513          	addi	a0,a0,-1528 # 7c58 <malloc+0x1c0c>
    4258:	00002097          	auipc	ra,0x2
    425c:	d3c080e7          	jalr	-708(ra) # 5f94 <printf>
    exit(1);
    4260:	4505                	li	a0,1
...
000000000000426a <iref>:
{
    ...
    4288:	9eca0a13          	addi	s4,s4,-1556 # 7c70 <malloc+0x1c24>
    mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	4ec48493          	addi	s1,s1,1260 # 7778 <malloc+0x172c>
    link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	0cca8a93          	addi	s5,s5,204 # 6360 <malloc+0x314>
    fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	8cc98993          	addi	s3,s3,-1844 # 7b68 <malloc+0x1b1c>
    42a4:	a891                	j	42f8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	9d050513          	addi	a0,a0,-1584 # 7c78 <malloc+0x1c2c>
    42b0:	00002097          	auipc	ra,0x2
    42b4:	ce4080e7          	jalr	-796(ra) # 5f94 <printf>
      exit(1);
    42b8:	4505                	li	a0,1
    ...
    42c8:	9cc50513          	addi	a0,a0,-1588 # 7c90 <malloc+0x1c44>
    42cc:	00002097          	auipc	ra,0x2
    42d0:	cc8080e7          	jalr	-824(ra) # 5f94 <printf>
      exit(1);
    42d4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    435c:	14098993          	addi	s3,s3,320 # 7498 <malloc+0x144c>
    unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	91090913          	addi	s2,s2,-1776 # 7c70 <malloc+0x1c24>
    chdir("..");
    4368:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4384:	0c050513          	addi	a0,a0,192 # 7440 <malloc+0x13f4>
...
00000000000043a4 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43b4:	8f850513          	addi	a0,a0,-1800 # 7ca8 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    43d8:	8d450513          	addi	a0,a0,-1836 # 7ca8 <malloc+0x1c5c>
    ...
    43ee:	8de50513          	addi	a0,a0,-1826 # 7cc8 <malloc+0x1c7c>
    43f2:	00002097          	auipc	ra,0x2
    43f6:	ba2080e7          	jalr	-1118(ra) # 5f94 <printf>
      exit(1);
    43fa:	4505                	li	a0,1
    ...
    440a:	8aa50513          	addi	a0,a0,-1878 # 7cb0 <malloc+0x1c64>
    440e:	00002097          	auipc	ra,0x2
    4412:	b86080e7          	jalr	-1146(ra) # 5f94 <printf>
    exit(1);
    4416:	4505                	li	a0,1
    ...
    4426:	5ee50513          	addi	a0,a0,1518 # 6a10 <malloc+0x9c4>
    442a:	00002097          	auipc	ra,0x2
    442e:	b6a080e7          	jalr	-1174(ra) # 5f94 <printf>
    exit(1);
    4432:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4454:	85850513          	addi	a0,a0,-1960 # 7ca8 <malloc+0x1c5c>
    ...
    4468:	79c50513          	addi	a0,a0,1948 # 6c00 <malloc+0xbb4>
    446c:	00002097          	auipc	ra,0x2
    4470:	b28080e7          	jalr	-1240(ra) # 5f94 <printf>
    exit(1);
    4474:	4505                	li	a0,1
...
0000000000004496 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44a6:	84e50513          	addi	a0,a0,-1970 # 7cf0 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44d2:	82250513          	addi	a0,a0,-2014 # 7cf0 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    450a:	6ca50513          	addi	a0,a0,1738 # 6bd0 <malloc+0xb84>
    450e:	00002097          	auipc	ra,0x2
    4512:	a86080e7          	jalr	-1402(ra) # 5f94 <printf>
    exit(1);
    4516:	4505                	li	a0,1
    ...
    4524:	7d048493          	addi	s1,s1,2000 # 7cf0 <malloc+0x1ca4>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	7a850513          	addi	a0,a0,1960 # 7cf0 <malloc+0x1ca4>
...
000000000000456c <killstatus>:
{
  ...
  exit(0);
    ...
    45d2:	44250513          	addi	a0,a0,1090 # 6a10 <malloc+0x9c4>
    45d6:	00002097          	auipc	ra,0x2
    45da:	9be080e7          	jalr	-1602(ra) # 5f94 <printf>
      exit(1);
    45de:	4505                	li	a0,1
    ...
    45f8:	70c50513          	addi	a0,a0,1804 # 7d00 <malloc+0x1cb4>
...
000000000000460e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4638:	59c50513          	addi	a0,a0,1436 # 6bd0 <malloc+0xb84>
    463c:	00002097          	auipc	ra,0x2
    4640:	958080e7          	jalr	-1704(ra) # 5f94 <printf>
    exit(1);
    4644:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4666:	3ae50513          	addi	a0,a0,942 # 6a10 <malloc+0x9c4>
    466a:	00002097          	auipc	ra,0x2
    466e:	92a080e7          	jalr	-1750(ra) # 5f94 <printf>
    exit(1);
    4672:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    46aa:	b5258593          	addi	a1,a1,-1198 # 61f8 <malloc+0x1ac>
    ...
    46d4:	34050513          	addi	a0,a0,832 # 6a10 <malloc+0x9c4>
    46d8:	00002097          	auipc	ra,0x2
    46dc:	8bc080e7          	jalr	-1860(ra) # 5f94 <printf>
     exit(1);
    46e0:	4505                	li	a0,1
    ...
    46f0:	63450513          	addi	a0,a0,1588 # 7d20 <malloc+0x1cd4>
    46f4:	00002097          	auipc	ra,0x2
    46f8:	8a0080e7          	jalr	-1888(ra) # 5f94 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    472c:	61050513          	addi	a0,a0,1552 # 7d38 <malloc+0x1cec>
    4730:	00002097          	auipc	ra,0x2
    4734:	864080e7          	jalr	-1948(ra) # 5f94 <printf>
}
  ...
  printf("kill... ");
    ...
    4758:	5fc50513          	addi	a0,a0,1532 # 7d50 <malloc+0x1d04>
    475c:	00002097          	auipc	ra,0x2
    4760:	838080e7          	jalr	-1992(ra) # 5f94 <printf>
  kill(pid1);
    4764:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4786:	5de50513          	addi	a0,a0,1502 # 7d60 <malloc+0x1d14>
    478a:	00002097          	auipc	ra,0x2
    478e:	80a080e7          	jalr	-2038(ra) # 5f94 <printf>
  wait(0);
    4792:	4501                	li	a0,0
...
00000000000047b2 <reparent>:
{
  ...
  exit(0);
    ...
    4806:	20e50513          	addi	a0,a0,526 # 6a10 <malloc+0x9c4>
    480a:	00001097          	auipc	ra,0x1
    480e:	78a080e7          	jalr	1930(ra) # 5f94 <printf>
      exit(1);
    4812:	4505                	li	a0,1
    ...
    4822:	37a50513          	addi	a0,a0,890 # 6b98 <malloc+0xb4c>
    4826:	00001097          	auipc	ra,0x1
    482a:	76e080e7          	jalr	1902(ra) # 5f94 <printf>
        exit(1);
    482e:	4505                	li	a0,1
...
0000000000004862 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4898:	28450513          	addi	a0,a0,644 # 6b18 <malloc+0xacc>
    489c:	00001097          	auipc	ra,0x1
    48a0:	6f8080e7          	jalr	1784(ra) # 5f94 <printf>
    exit(1);
    48a4:	4505                	li	a0,1
    ...
    48cc:	93058593          	addi	a1,a1,-1744 # 61f8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4990:	3e450513          	addi	a0,a0,996 # 7d70 <malloc+0x1d24>
    4994:	00001097          	auipc	ra,0x1
    4998:	600080e7          	jalr	1536(ra) # 5f94 <printf>
    exit(1);
    499c:	4505                	li	a0,1
    ...
    49ac:	06850513          	addi	a0,a0,104 # 6a10 <malloc+0x9c4>
    49b0:	00001097          	auipc	ra,0x1
    49b4:	5e4080e7          	jalr	1508(ra) # 5f94 <printf>
    exit(1);
    49b8:	4505                	li	a0,1
    ...
    49f8:	39c50513          	addi	a0,a0,924 # 7d90 <malloc+0x1d44>
    49fc:	00001097          	auipc	ra,0x1
    4a00:	598080e7          	jalr	1432(ra) # 5f94 <printf>
    exit(1);
    4a04:	4505                	li	a0,1
...
0000000000004a18 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a62:	5ee080e7          	jalr	1518(ra) # 604c <malloc>
    ...
    4a9c:	32850513          	addi	a0,a0,808 # 7dc0 <malloc+0x1d74>
    4aa0:	00001097          	auipc	ra,0x1
    4aa4:	4f4080e7          	jalr	1268(ra) # 5f94 <printf>
      exit(1);
    4aa8:	4505                	li	a0,1
...
0000000000004abc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b5e:	29650513          	addi	a0,a0,662 # 7df0 <malloc+0x1da4>
    4b62:	00001097          	auipc	ra,0x1
    4b66:	432080e7          	jalr	1074(ra) # 5f94 <printf>
    exit(1);
    4b6a:	4505                	li	a0,1
    ...
    4b7a:	2a250513          	addi	a0,a0,674 # 7e18 <malloc+0x1dcc>
    4b7e:	00001097          	auipc	ra,0x1
    4b82:	416080e7          	jalr	1046(ra) # 5f94 <printf>
      exit(1);
    4b86:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4bbe:	22650513          	addi	a0,a0,550 # 7de0 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bfe:	23e50513          	addi	a0,a0,574 # 7e38 <malloc+0x1dec>
    4c02:	00001097          	auipc	ra,0x1
    4c06:	392080e7          	jalr	914(ra) # 5f94 <printf>
    exit(1);
    4c0a:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4c3a:	1aa50513          	addi	a0,a0,426 # 7de0 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c60:	20450513          	addi	a0,a0,516 # 7e60 <malloc+0x1e14>
    4c64:	00001097          	auipc	ra,0x1
    4c68:	330080e7          	jalr	816(ra) # 5f94 <printf>
    exit(1);
    4c6c:	4505                	li	a0,1
...
0000000000004c80 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4ca4:	1d878793          	addi	a5,a5,472 # 7e78 <malloc+0x1e2c>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	1d478793          	addi	a5,a5,468 # 7e80 <malloc+0x1e34>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	1d078793          	addi	a5,a5,464 # 7e88 <malloc+0x1e3c>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	1cc78793          	addi	a5,a5,460 # 7e90 <malloc+0x1e44>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d36:	0e650513          	addi	a0,a0,230 # 6e18 <malloc+0xdcc>
    4d3a:	00001097          	auipc	ra,0x1
    4d3e:	25a080e7          	jalr	602(ra) # 5f94 <printf>
      exit(1);
    4d42:	4505                	li	a0,1
    ...
    4db0:	0ec50513          	addi	a0,a0,236 # 7e98 <malloc+0x1e4c>
    4db4:	00001097          	auipc	ra,0x1
    4db8:	1e0080e7          	jalr	480(ra) # 5f94 <printf>
        exit(1);
    4dbc:	4505                	li	a0,1
    ...
    4dca:	0e250513          	addi	a0,a0,226 # 7ea8 <malloc+0x1e5c>
    4dce:	00001097          	auipc	ra,0x1
    4dd2:	1c6080e7          	jalr	454(ra) # 5f94 <printf>
          exit(1);
    4dd6:	4505                	li	a0,1
    ...
    4df0:	0d450513          	addi	a0,a0,212 # 7ec0 <malloc+0x1e74>
    4df4:	00001097          	auipc	ra,0x1
    4df8:	1a0080e7          	jalr	416(ra) # 5f94 <printf>
          exit(1);
    4dfc:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e78:	05c50513          	addi	a0,a0,92 # 7ed0 <malloc+0x1e84>
    4e7c:	00001097          	auipc	ra,0x1
    4e80:	118080e7          	jalr	280(ra) # 5f94 <printf>
      exit(1);
    4e84:	4505                	li	a0,1
...
0000000000004eac <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eda:	012b8b93          	addi	s7,s7,18 # 7ee8 <malloc+0x1e9c>
  for(i = 0; i < N; i++){
    ...
    4f1c:	fd850513          	addi	a0,a0,-40 # 7ef0 <malloc+0x1ea4>
    4f20:	00001097          	auipc	ra,0x1
    4f24:	074080e7          	jalr	116(ra) # 5f94 <printf>
        exit(1);
    4f28:	4505                	li	a0,1
    ...
    4f3a:	fb250513          	addi	a0,a0,-78 # 7ee8 <malloc+0x1e9c>
  ...
  fd = open(".", 0);
    ...
    4f72:	90250513          	addi	a0,a0,-1790 # 6870 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fea:	f2a50513          	addi	a0,a0,-214 # 7f10 <malloc+0x1ec4>
    4fee:	00001097          	auipc	ra,0x1
    4ff2:	fa6080e7          	jalr	-90(ra) # 5f94 <printf>
        exit(1);
    4ff6:	4505                	li	a0,1
    ...
    500a:	f2a50513          	addi	a0,a0,-214 # 7f30 <malloc+0x1ee4>
    500e:	00001097          	auipc	ra,0x1
    5012:	f86080e7          	jalr	-122(ra) # 5f94 <printf>
        exit(1);
    5016:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    5042:	f1a50513          	addi	a0,a0,-230 # 7f58 <malloc+0x1f0c>
    5046:	00001097          	auipc	ra,0x1
    504a:	f4e080e7          	jalr	-178(ra) # 5f94 <printf>
    exit(1);
    504e:	4505                	li	a0,1
    ...
    505e:	9b650513          	addi	a0,a0,-1610 # 6a10 <malloc+0x9c4>
    5062:	00001097          	auipc	ra,0x1
    5066:	f32080e7          	jalr	-206(ra) # 5f94 <printf>
      exit(1);
    506a:	4505                	li	a0,1
...
0000000000005208 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5290:	d0450513          	addi	a0,a0,-764 # 7f90 <malloc+0x1f44>
  ...
  for(i = 0; ; i++){
    ...
    52f4:	cb050513          	addi	a0,a0,-848 # 7fa0 <malloc+0x1f54>
    52f8:	00001097          	auipc	ra,0x1
    52fc:	c9c080e7          	jalr	-868(ra) # 5f94 <printf>
    exit(1);
    5300:	4505                	li	a0,1
    ...
    5310:	cb450513          	addi	a0,a0,-844 # 7fc0 <malloc+0x1f74>
    5314:	00001097          	auipc	ra,0x1
    5318:	c80080e7          	jalr	-896(ra) # 5f94 <printf>
      exit(1);
    531c:	4505                	li	a0,1
    ...
    532c:	cb850513          	addi	a0,a0,-840 # 7fe0 <malloc+0x1f94>
    5330:	00001097          	auipc	ra,0x1
    5334:	c64080e7          	jalr	-924(ra) # 5f94 <printf>
    exit(1);
    5338:	4505                	li	a0,1
    ...
    5348:	cbc50513          	addi	a0,a0,-836 # 8000 <malloc+0x1fb4>
    534c:	00001097          	auipc	ra,0x1
    5350:	c48080e7          	jalr	-952(ra) # 5f94 <printf>
      exit(1);
    5354:	4505                	li	a0,1
    ...
    5364:	cc050513          	addi	a0,a0,-832 # 8020 <malloc+0x1fd4>
    5368:	00001097          	auipc	ra,0x1
    536c:	c2c080e7          	jalr	-980(ra) # 5f94 <printf>
      exit(1);
    5370:	4505                	li	a0,1
    ...
    5380:	cbc50513          	addi	a0,a0,-836 # 8038 <malloc+0x1fec>
    5384:	00001097          	auipc	ra,0x1
    5388:	c10080e7          	jalr	-1008(ra) # 5f94 <printf>
      exit(1);
    538c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    53ae:	be650513          	addi	a0,a0,-1050 # 7f90 <malloc+0x1f44>
    ...
    53d2:	c8a50513          	addi	a0,a0,-886 # 8058 <malloc+0x200c>
    53d6:	00001097          	auipc	ra,0x1
    53da:	bbe080e7          	jalr	-1090(ra) # 5f94 <printf>
    exit(1);
    53de:	4505                	li	a0,1
...
00000000000053e8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    5408:	c7450513          	addi	a0,a0,-908 # 8078 <malloc+0x202c>
    540c:	00001097          	auipc	ra,0x1
    5410:	b88080e7          	jalr	-1144(ra) # 5f94 <printf>
  for(nfiles = 0; ; nfiles++){
    5414:	4481                	li	s1,0
    name[0] = 'f';
    ...
    5428:	c64c8c93          	addi	s9,s9,-924 # 8088 <malloc+0x203c>
    name[0] = 'f';
    ...
    5498:	c0450513          	addi	a0,a0,-1020 # 8098 <malloc+0x204c>
    549c:	00001097          	auipc	ra,0x1
    54a0:	af8080e7          	jalr	-1288(ra) # 5f94 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    550e:	bae50513          	addi	a0,a0,-1106 # 80b8 <malloc+0x206c>
    5512:	00001097          	auipc	ra,0x1
    5516:	a82080e7          	jalr	-1406(ra) # 5f94 <printf>
}
    ...
    5564:	b4850513          	addi	a0,a0,-1208 # 80a8 <malloc+0x205c>
    5568:	00001097          	auipc	ra,0x1
    556c:	a2c080e7          	jalr	-1492(ra) # 5f94 <printf>
    close(fd);
    5570:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5596:	b3e50513          	addi	a0,a0,-1218 # 80d0 <malloc+0x2084>
    559a:	00001097          	auipc	ra,0x1
    559e:	9fa080e7          	jalr	-1542(ra) # 5f94 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    55c6:	b3650513          	addi	a0,a0,-1226 # 80f8 <malloc+0x20ac>
    55ca:	00001097          	auipc	ra,0x1
    55ce:	9ca080e7          	jalr	-1590(ra) # 5f94 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55ea:	afa50513          	addi	a0,a0,-1286 # 80e0 <malloc+0x2094>
    55ee:	00001097          	auipc	ra,0x1
    55f2:	9a6080e7          	jalr	-1626(ra) # 5f94 <printf>
    exit(1);
    55f6:	4505                	li	a0,1
    ...
    5612:	af250513          	addi	a0,a0,-1294 # 8100 <malloc+0x20b4>
    5616:	00001097          	auipc	ra,0x1
    561a:	97e080e7          	jalr	-1666(ra) # 5f94 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5662:	aaa50513          	addi	a0,a0,-1366 # 8108 <malloc+0x20bc>
    5666:	00001097          	auipc	ra,0x1
    566a:	92e080e7          	jalr	-1746(ra) # 5f94 <printf>
        return 1;
    566e:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56bc:	b4098993          	addi	s3,s3,-1216 # 61f8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    56ee:	a7650513          	addi	a0,a0,-1418 # 8160 <malloc+0x2114>
    56f2:	00001097          	auipc	ra,0x1
    56f6:	8a2080e7          	jalr	-1886(ra) # 5f94 <printf>
        exit(1);
    56fa:	4505                	li	a0,1
    ...
    570e:	a1650513          	addi	a0,a0,-1514 # 8120 <malloc+0x20d4>
    5712:	00001097          	auipc	ra,0x1
    5716:	882080e7          	jalr	-1918(ra) # 5f94 <printf>
    exit(1);
    571a:	4505                	li	a0,1
    ...
    572e:	a1650513          	addi	a0,a0,-1514 # 8140 <malloc+0x20f4>
    5732:	00001097          	auipc	ra,0x1
    5736:	862080e7          	jalr	-1950(ra) # 5f94 <printf>
    exit(1);
    573a:	4505                	li	a0,1
  ...
  while(1){
    ...
    5782:	a0250513          	addi	a0,a0,-1534 # 8180 <malloc+0x2134>
    5786:	00001097          	auipc	ra,0x1
    578a:	80e080e7          	jalr	-2034(ra) # 5f94 <printf>
      exit(1);
    578e:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57e0:	9c4b8b93          	addi	s7,s7,-1596 # 81a0 <malloc+0x2154>
    int free0 = countfree();
    int free1 = 0;
    ...
    57fa:	9c2d0d13          	addi	s10,s10,-1598 # 81b8 <malloc+0x216c>
          return 1;
        }
      }
    }
    ...
    5802:	9dac8c93          	addi	s9,s9,-1574 # 81d8 <malloc+0x218c>
    5806:	a839                	j	5824 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    5808:	856a                	mv	a0,s10
    580a:	00000097          	auipc	ra,0x0
    580e:	78a080e7          	jalr	1930(ra) # 5f94 <printf>
    ...
    582a:	76e080e7          	jalr	1902(ra) # 5f94 <printf>
    int free0 = countfree();
    ...
    5872:	726080e7          	jalr	1830(ra) # 5f94 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58da:	93258593          	addi	a1,a1,-1742 # 8208 <malloc+0x21bc>
  ...
  char *justone = 0;
    ...
    58f8:	91c58593          	addi	a1,a1,-1764 # 8210 <malloc+0x21c4>
    ...
    590e:	95658593          	addi	a1,a1,-1706 # 8260 <malloc+0x2214>
  ...
  int continuous = 0;
    ...
    593a:	8e250513          	addi	a0,a0,-1822 # 8218 <malloc+0x21cc>
    593e:	00000097          	auipc	ra,0x0
    5942:	656080e7          	jalr	1622(ra) # 5f94 <printf>
    exit(1);
    5946:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5960:	8ec50513          	addi	a0,a0,-1812 # 8248 <malloc+0x21fc>
    5964:	00000097          	auipc	ra,0x0
    5968:	630080e7          	jalr	1584(ra) # 5f94 <printf>
  exit(0);
    596c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5d10:	91c50513          	addi	a0,a0,-1764 # 8628 <digits>
    5d14:	883a                	mv	a6,a4
    5d16:	2705                	addiw	a4,a4,1
    5d18:	02c5f7bb          	remuw	a5,a1,a2
    5d1c:	1782                	slli	a5,a5,0x20
    5d1e:	9381                	srli	a5,a5,0x20
  ...
  while(--i >= 0)
    ...
    5d60:	fff78993          	addi	s3,a5,-1
    5d64:	99ba                	add	s3,s3,a4
    5d66:	377d                	addiw	a4,a4,-1
    5d68:	1702                	slli	a4,a4,0x20
    5d6a:	9301                	srli	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5e0e:	00271793          	slli	a5,a4,0x2
    5e12:	00002717          	auipc	a4,0x2
    5e16:	7be70713          	addi	a4,a4,1982 # 85d0 <malloc+0x2584>
    5e1a:	97ba                	add	a5,a5,a4
    5e1c:	439c                	lw	a5,0(a5)
    5e1e:	97ba                	add	a5,a5,a4
    5e20:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5e22:	008b8913          	addi	s2,s7,8
    5e26:	4685                	li	a3,1
    5e28:	4629                	li	a2,10
  ...
  putc(fd, 'x');
    ...
    5ea2:	78ab8b93          	addi	s7,s7,1930 # 8628 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ef8:	6b490913          	addi	s2,s2,1716 # 85a8 <malloc+0x255c>
        while(*s != 0){
    5efc:	02800593          	li	a1,40
    5f00:	bff1                	j	5edc <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5f02:	008b8913          	addi	s2,s7,8
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fd4:	00004797          	auipc	a5,0x4
    5fd8:	7fc7b783          	ld	a5,2044(a5) # a7d0 <freep>
    ...
    6000:	00e6ea63          	bltu	a3,a4,6014 <free+0x4a>
{
  ...
  freep = p;
    ...
    6042:	78f73923          	sd	a5,1938(a4) # a7d0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    6068:	00004517          	auipc	a0,0x4
    606c:	76853503          	ld	a0,1896(a0) # a7d0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    6098:	00004917          	auipc	s2,0x4
    609c:	73890913          	addi	s2,s2,1848 # a7d0 <freep>
  if(p == (char*)-1)
    60a0:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    60ac:	0000b797          	auipc	a5,0xb
    60b0:	f4c78793          	addi	a5,a5,-180 # 10ff8 <base>
    60b4:	00004717          	auipc	a4,0x4
    60b8:	70f73e23          	sd	a5,1820(a4) # a7d0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    60f6:	b92080e7          	jalr	-1134(ra) # 5c84 <sbrk>
  if(p == (char*)-1)
    ...
    611a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    611c:	02071693          	slli	a3,a4,0x20
    6120:	01c6d713          	srli	a4,a3,0x1c
    6124:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6126:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    612a:	00004717          	auipc	a4,0x4
    612e:	6aa73323          	sd	a0,1702(a4) # a7d0 <freep>
      return (void*)(p + 1);
    6132:	01078513          	addi	a0,a5,16
  }
}
