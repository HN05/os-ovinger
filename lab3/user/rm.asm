...
free(void *ap)
{
 ...
 6dc:	d087b783          	ld	a5,-760(a5) # 13e0 <freep>
 ...
 704:	00e6ea63          	bltu	a3,a4,718 <free+0x4a>
{
 ...
 746:	c8f73f23          	sd	a5,-866(a4) # 13e0 <freep>
}
 74a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 770:	c7453503          	ld	a0,-908(a0) # 13e0 <freep>
 ...
 7a0:	c4490913          	addi	s2,s2,-956 # 13e0 <freep>
  if(p == (char*)-1)
 7a4:	5afd                	li	s5,-1
 ...
 7b4:	c4078793          	addi	a5,a5,-960 # 13f0 <base>
 7b8:	00001717          	auipc	a4,0x1
 7bc:	c2f73423          	sd	a5,-984(a4) # 13e0 <freep>
 7c0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 832:	baa73923          	sd	a0,-1102(a4) # 13e0 <freep>
      return (void*)(p + 1);
