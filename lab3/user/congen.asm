...
void forktest(void)
{
  ...
  46:	87e50513          	addi	a0,a0,-1922 # 8c0 <malloc+0x104>
  ...
  70:	874b0b13          	addi	s6,s6,-1932 # 8e0 <malloc+0x124>
            printf("CHILD %d: %d\n", n, i);
  74:	00001a97          	auipc	s5,0x1
  78:	85ca8a93          	addi	s5,s5,-1956 # 8d0 <malloc+0x114>
    for (unsigned long long i = 0; i < 1000; i++)
  ...
  ac:	84850513          	addi	a0,a0,-1976 # 8f0 <malloc+0x134>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46c:	0805cb63          	bltz	a1,502 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 480:	4e450513          	addi	a0,a0,1252 # 960 <digits>
 484:	883a                	mv	a6,a4
 ...
 4bc:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 4c0:	02e05c63          	blez	a4,4f8 <printint+0x9a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 518:	1a090a63          	beqz	s2,6cc <vprintf+0x1c2>
 ...
 542:	efe080e7          	jalr	-258(ra) # 43c <putc>
 ...
 552:	16090763          	beqz	s2,6c0 <vprintf+0x1b6>
    if(state == 0){
 ...
 560:	b7f5                	j	54c <vprintf+0x42>
      if(c == 'd'){
 562:	13490463          	beq	s2,s4,68a <vprintf+0x180>
 566:	f9d9079b          	addiw	a5,s2,-99
 56a:	0ff7f793          	zext.b	a5,a5
 56e:	12fb6763          	bltu	s6,a5,69c <vprintf+0x192>
 572:	f9d9079b          	addiw	a5,s2,-99
 576:	0ff7f713          	zext.b	a4,a5
 57a:	12eb6163          	bltu	s6,a4,69c <vprintf+0x192>
 57e:	00271793          	slli	a5,a4,0x2
 582:	00000717          	auipc	a4,0x0
 586:	38670713          	addi	a4,a4,902 # 908 <malloc+0x14c>
 ...
 5a4:	ebe080e7          	jalr	-322(ra) # 45e <printint>
 5a8:	8bca                	mv	s7,s2
      } else {
 ...
 5c0:	ea2080e7          	jalr	-350(ra) # 45e <printint>
 5c4:	8bca                	mv	s7,s2
      state = 0;
 5c6:	4981                	li	s3,0
 ...
 5dc:	e86080e7          	jalr	-378(ra) # 45e <printint>
 5e0:	8bca                	mv	s7,s2
      state = 0;
 5e2:	4981                	li	s3,0
 ...
 612:	352b8b93          	addi	s7,s7,850 # 960 <digits>
 ...
 634:	4981                	li	s3,0
 636:	6c02                	ld	s8,0(sp)
 638:	bf11                	j	54c <vprintf+0x42>
        s = va_arg(ap, char*);
 63a:	008b8993          	addi	s3,s7,8
 63e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
 642:	02090163          	beqz	s2,664 <vprintf+0x15a>
        while(*s != 0){
 646:	00094583          	lbu	a1,0(s2)
 64a:	c9a5                	beqz	a1,6ba <vprintf+0x1b0>
          putc(fd, *s);
 64c:	8556                	mv	a0,s5
 ...
 65c:	f9e5                	bnez	a1,64c <vprintf+0x142>
        s = va_arg(ap, char*);
 65e:	8bce                	mv	s7,s3
      state = 0;
 660:	4981                	li	s3,0
 662:	b5ed                	j	54c <vprintf+0x42>
          s = "(null)";
 664:	00000917          	auipc	s2,0x0
 668:	29c90913          	addi	s2,s2,668 # 900 <malloc+0x144>
        while(*s != 0){
 66c:	02800593          	li	a1,40
 670:	bff1                	j	64c <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
 672:	008b8913          	addi	s2,s7,8
 676:	000bc583          	lbu	a1,0(s7)
 67a:	8556                	mv	a0,s5
 67c:	00000097          	auipc	ra,0x0
 680:	dc0080e7          	jalr	-576(ra) # 43c <putc>
 684:	8bca                	mv	s7,s2
      state = 0;
 686:	4981                	li	s3,0
 688:	b5d1                	j	54c <vprintf+0x42>
        putc(fd, c);
 68a:	02500593          	li	a1,37
 68e:	8556                	mv	a0,s5
 690:	00000097          	auipc	ra,0x0
 694:	dac080e7          	jalr	-596(ra) # 43c <putc>
      state = 0;
 698:	4981                	li	s3,0
 69a:	bd4d                	j	54c <vprintf+0x42>
        putc(fd, '%');
 69c:	02500593          	li	a1,37
 6a0:	8556                	mv	a0,s5
 6a2:	00000097          	auipc	ra,0x0
 6a6:	d9a080e7          	jalr	-614(ra) # 43c <putc>
        putc(fd, c);
 6aa:	85ca                	mv	a1,s2
 6ac:	8556                	mv	a0,s5
 6ae:	00000097          	auipc	ra,0x0
 6b2:	d8e080e7          	jalr	-626(ra) # 43c <putc>
      state = 0;
 6b6:	4981                	li	s3,0
 6b8:	bd51                	j	54c <vprintf+0x42>
        s = va_arg(ap, char*);
 6ba:	8bce                	mv	s7,s3
      state = 0;
 6bc:	4981                	li	s3,0
 6be:	b579                	j	54c <vprintf+0x42>
...
free(void *ap)
{
 ...
 748:	cfc7b783          	ld	a5,-772(a5) # 1440 <freep>
 ...
 770:	00e6ea63          	bltu	a3,a4,784 <free+0x4a>
{
 ...
 7b2:	c8f73923          	sd	a5,-878(a4) # 1440 <freep>
}
 7b6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7dc:	c6853503          	ld	a0,-920(a0) # 1440 <freep>
 ...
 7e2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 7e4:	4798                	lw	a4,8(a5)
 7e6:	08977e63          	bgeu	a4,s1,882 <malloc+0xc6>
 ...
 804:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 808:	00001917          	auipc	s2,0x1
 80c:	c3890913          	addi	s2,s2,-968 # 1440 <freep>
  if(p == (char*)-1)
 810:	5afd                	li	s5,-1
 812:	a091                	j	856 <malloc+0x9a>
 ...
 820:	c3478793          	addi	a5,a5,-972 # 1450 <base>
 824:	00001717          	auipc	a4,0x1
 828:	c0f73e23          	sd	a5,-996(a4) # 1440 <freep>
 82c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 834:	6398                	ld	a4,0(a5)
 836:	e118                	sd	a4,0(a0)
 838:	a08d                	j	89a <malloc+0xde>
  hp->s.size = nu;
 83a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 83e:	0541                	addi	a0,a0,16
 840:	00000097          	auipc	ra,0x0
 844:	efa080e7          	jalr	-262(ra) # 73a <free>
  return freep;
 848:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 84c:	c13d                	beqz	a0,8b2 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 84e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 850:	4798                	lw	a4,8(a5)
 852:	02977463          	bgeu	a4,s1,87a <malloc+0xbe>
    if(p == freep)
 856:	00093703          	ld	a4,0(s2)
 85a:	853e                	mv	a0,a5
 85c:	fef719e3          	bne	a4,a5,84e <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
 860:	8552                	mv	a0,s4
 862:	00000097          	auipc	ra,0x0
 866:	b92080e7          	jalr	-1134(ra) # 3f4 <sbrk>
  if(p == (char*)-1)
 86a:	fd5518e3          	bne	a0,s5,83a <malloc+0x7e>
        return 0;
 86e:	4501                	li	a0,0
 ...
 874:	6aa2                	ld	s5,8(sp)
 876:	6b02                	ld	s6,0(sp)
 878:	a03d                	j	8a6 <malloc+0xea>
 87a:	7902                	ld	s2,32(sp)
 87c:	6a42                	ld	s4,16(sp)
 87e:	6aa2                	ld	s5,8(sp)
 880:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 882:	fae489e3          	beq	s1,a4,834 <malloc+0x78>
        p->s.size -= nunits;
 ...
 896:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 89a:	00001717          	auipc	a4,0x1
 89e:	baa73323          	sd	a0,-1114(a4) # 1440 <freep>
      return (void*)(p + 1);
