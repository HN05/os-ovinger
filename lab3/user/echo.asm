...
free(void *ap)
{
 ...
 6f0:	cf47b783          	ld	a5,-780(a5) # 13e0 <freep>
 ...
 718:	00e6ea63          	bltu	a3,a4,72c <free+0x4a>
{
 ...
 75a:	c8f73523          	sd	a5,-886(a4) # 13e0 <freep>
}
 75e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 784:	c6053503          	ld	a0,-928(a0) # 13e0 <freep>
 ...
 7b4:	c3090913          	addi	s2,s2,-976 # 13e0 <freep>
  if(p == (char*)-1)
 7b8:	5afd                	li	s5,-1
 ...
 7c8:	c2c78793          	addi	a5,a5,-980 # 13f0 <base>
 ...
 846:	b8a73f23          	sd	a0,-1122(a4) # 13e0 <freep>
      return (void*)(p + 1);
